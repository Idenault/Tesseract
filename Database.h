...
public:
	...
	void addTrackToRecording(int albumID, int songID);
	//object deletion
	...
	void removeTrackFromRecording(int albumID, int songID);
	void removeTrackFromAllRecordings(int songID);
	//getters
	...
	void showSongsInPlaylist(string userID, string playlistName);
